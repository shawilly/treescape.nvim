...
function M.setup(c, config)
	...
	set_hl("Constant", { fg = c.fg })
	set_hl("String", { fg = c.soil })
	set_hl("Character", { fg = c.soil })
	set_hl("Number", { fg = c.stream })
	set_hl("Boolean", { fg = c.mist })
	...
	set_hl("@character", { fg = c.sunflower })
	...
	set_hl("@lsp.type.parameter", { fg = c.orange })
	set_hl("@lsp.type.property", { fg = c.fg })
	set_hl("@lsp.type.regexp", { fg = c.orange })
	set_hl("@lsp.type.string", { fg = c.sunflower })
	...
	set_hl("@type.tsx", { fg = c.stream })
	set_hl("@lsp.type.type.typescript", { fg = c.stream })
	set_hl("@lsp.type.type.typescriptreact", { fg = c.stream })
	set_hl("@lsp.type.interface.typescript", { fg = c.stream })
	set_hl("@lsp.type.interface.typescriptreact", { fg = c.stream })
