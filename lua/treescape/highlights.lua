...
function M.setup(c, config)
	...
	-- When transparent is enabled, bg is set to NONE and terminal controls actual opacity
	...
	local pmenu_bg = transparent and "NONE" or c.pmenu
	...
	set_hl("NormalFloat", { fg = c.fg, bg = pmenu_bg })
	set_hl("FloatBorder", { fg = c.border, bg = pmenu_bg })
	set_hl("FloatTitle", { fg = c.green_bright, bg = pmenu_bg, bold = true })
	...
	set_hl("QuickFixLine", { bg = c.bg_visual, bold = true })

	-----------------------------------------------------------------------------
	-- Syntax highlights
	-----------------------------------------------------------------------------
	set_hl("Comment", vim.tbl_extend("force", { fg = c.comment }, styles.comments))
	set_hl("Constant", { fg = c.wood })
	set_hl("String", { fg = c.moss })
	set_hl("Character", { fg = c.moss })
	set_hl("Number", { fg = c.sunflower })
	set_hl("Boolean", { fg = c.bark })
	set_hl("Float", { fg = c.stream_dark })
	set_hl("Identifier", { fg = c.fg })
	set_hl("Function", vim.tbl_extend("force", { fg = c.leaf }, styles.functions))
	set_hl("Statement", { fg = c.bark })
	set_hl("Conditional", vim.tbl_extend("force", { fg = c.bark }, styles.keywords))
	set_hl("Repeat", vim.tbl_extend("force", { fg = c.bark }, styles.keywords))
	set_hl("Label", { fg = c.soil })
	set_hl("Operator", { fg = c.fg_dark })
	set_hl("Keyword", vim.tbl_extend("force", { fg = c.bark }, styles.keywords))
	set_hl("Exception", { fg = c.berry })
	set_hl("PreProc", { fg = c.dew })
	set_hl("Include", { fg = c.stream })
	set_hl("Define", { fg = c.dew })
	set_hl("Macro", { fg = c.dew })
	set_hl("PreCondit", { fg = c.dew })
	set_hl("Type", { fg = c.stream, bold = true })
	set_hl("StorageClass", { fg = c.bark_dark })
	set_hl("Structure", { fg = c.stream })
	set_hl("Typedef", { fg = c.stream })
	set_hl("Special", { fg = c.soil })
	set_hl("SpecialChar", { fg = c.soil })
	set_hl("Tag", { fg = c.berry })
	set_hl("Delimiter", { fg = c.fg_dark })
	set_hl("SpecialComment", { fg = c.comment, italic = true })
	set_hl("Debug", { fg = c.berry })
	...
	set_hl("@variable.builtin", { fg = c.soil })
	set_hl("@variable.parameter", { fg = c.wood })
	set_hl("@variable.member", { fg = c.fg_dark })
	set_hl("@constant", { fg = c.wood })
	set_hl("@constant.builtin", { fg = c.bark_dark })
	set_hl("@constant.macro", { fg = c.dew })
	set_hl("@module", { fg = c.stream })
	set_hl("@module.builtin", { fg = c.stream })
	set_hl("@label", { fg = c.soil })
	...
	set_hl("@string.escape", { fg = c.soil })
	set_hl("@string.special", { fg = c.soil_dark })
	set_hl("@string.special.symbol", { fg = c.soil })
	set_hl("@string.special.url", { fg = c.stream, underline = true })
	set_hl("@character", { fg = c.moss })
	set_hl("@character.special", { fg = c.soil })
	set_hl("@boolean", { fg = c.bark })
	set_hl("@number", { fg = c.sunflower })
	set_hl("@number.float", { fg = c.sunflower })

	-- Types
	set_hl("@type", { fg = c.stream, bold = true })
	set_hl("@type.builtin", { fg = c.stream, bold = true })
	set_hl("@type.definition", { fg = c.stream, bold = true })
	set_hl("@type.qualifier", { fg = c.bark_dark })
	set_hl("@attribute", { fg = c.dew })
	set_hl("@property", { fg = c.fg })

	-- Functions
	set_hl("@function", vim.tbl_extend("force", { fg = c.leaf }, styles.functions))
	set_hl("@function.builtin", { fg = c.leaf })
	set_hl("@function.call", { fg = c.leaf })
	set_hl("@function.macro", { fg = c.dew })
	set_hl("@function.method", { fg = c.leaf })
	set_hl("@function.method.call", { fg = c.leaf })
	set_hl("@constructor", { fg = c.stream })

	-- Keywords
	set_hl("@keyword", vim.tbl_extend("force", { fg = c.bark }, styles.keywords))
	set_hl("@keyword.coroutine", { fg = c.bark })
	set_hl("@keyword.function", { fg = c.bark })
	set_hl("@keyword.operator", { fg = c.fg_dark })
	set_hl("@keyword.import", { fg = c.stream })
	set_hl("@keyword.storage", { fg = c.bark_dark })
	set_hl("@keyword.repeat", { fg = c.bark })
	set_hl("@keyword.return", { fg = c.bark })
	set_hl("@keyword.debug", { fg = c.berry })
	set_hl("@keyword.exception", { fg = c.berry })
	set_hl("@keyword.conditional", { fg = c.bark })
	set_hl("@keyword.conditional.ternary", { fg = c.bark_dark })
	set_hl("@keyword.directive", { fg = c.dew })
	set_hl("@keyword.directive.define", { fg = c.dew })

	-- Punctuation
	set_hl("@punctuation.delimiter", { fg = c.fg_dark })
	set_hl("@punctuation.bracket", { fg = c.fg_dark })
	set_hl("@punctuation.special", { fg = c.soil })
	...
	set_hl("@markup.heading", { fg = c.bark, bold = true })
	set_hl("@markup.quote", { fg = c.comment, italic = true })
	set_hl("@markup.math", { fg = c.soil })
	...
	-- Tags (HTML/JSX)
	set_hl("@tag", { fg = c.green_dim })
	set_hl("@tag.attribute", { fg = c.wood })
	set_hl("@tag.delimiter", { fg = c.fg_dark })

	-----------------------------------------------------------------------------
	-- LSP Semantic Tokens
	-----------------------------------------------------------------------------
	set_hl("@lsp.type.class", { fg = c.stream })
	set_hl("@lsp.type.comment", { fg = c.comment })
	set_hl("@lsp.type.decorator", { fg = c.dew })
	set_hl("@lsp.type.enum", { fg = c.stream })
	set_hl("@lsp.type.enumMember", { fg = c.fg_dark })
	set_hl("@lsp.type.function", { fg = c.leaf })
	set_hl("@lsp.type.interface", { fg = c.stream })
	set_hl("@lsp.type.keyword", { fg = c.bark })
	set_hl("@lsp.type.macro", { fg = c.dew })
	set_hl("@lsp.type.method", { fg = c.leaf })
	set_hl("@lsp.type.namespace", { fg = c.stream })
	set_hl("@lsp.type.number", { fg = c.sunflower })
	set_hl("@lsp.type.operator", { fg = c.fg_dark })
	set_hl("@lsp.type.parameter", { fg = c.wood })
	set_hl("@lsp.type.property", { fg = c.fg })
	set_hl("@lsp.type.regexp", { fg = c.orange })
	set_hl("@lsp.type.string", { fg = c.moss })
	set_hl("@lsp.type.struct", { fg = c.stream, bold = true })
	set_hl("@lsp.type.type", { fg = c.stream, bold = true })
	set_hl("@lsp.type.typeParameter", { fg = c.stream, bold = true })
	...
	set_hl("@lsp.typemod.function.defaultLibrary", { fg = c.leaf })
	set_hl("@lsp.typemod.method.defaultLibrary", { fg = c.leaf })
	...
	set_hl("DiagnosticVirtualTextWarn", { fg = c.warning, bg = c.diag_warn_bg })
	set_hl("DiagnosticVirtualTextInfo", { fg = c.info, bg = c.diag_info_bg })
	set_hl("DiagnosticVirtualTextHint", { fg = c.hint, bg = c.diag_hint_bg })
	...
	set_hl("LspInlayHint", { fg = c.comment, bg = bg_highlight, italic = true })

	-----------------------------------------------------------------------------
	-- Language-specific highlights
	-----------------------------------------------------------------------------
	-- Go
	set_hl("@operator.go", { fg = c.berry })
	set_hl("@punctuation.special.go", { fg = c.berry })
	set_hl("@type.go", { fg = c.stream, bold = true })
	set_hl("@type.builtin.go", { fg = c.stream, bold = true })
	set_hl("@lsp.type.type.go", { fg = c.stream, bold = true })
	set_hl("@lsp.type.interface.go", { fg = c.stream, bold = true })
	set_hl("@lsp.type.struct.go", { fg = c.stream, bold = true })
	set_hl("@lsp.type.typeParameter.go", { fg = c.stream, bold = true })

	-- TypeScript/JavaScript
	set_hl("@type.typescript", { fg = c.stream, bold = true })
	set_hl("@type.tsx", { fg = c.stream, bold = true })
	set_hl("@lsp.type.type.typescript", { fg = c.stream, bold = true })
	set_hl("@lsp.type.type.typescriptreact", { fg = c.stream, bold = true })
	set_hl("@lsp.type.interface.typescript", { fg = c.stream, bold = true })
	set_hl("@lsp.type.interface.typescriptreact", { fg = c.stream, bold = true })
